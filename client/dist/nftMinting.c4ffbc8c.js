...
})({"kYv7K":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d23f912fc4ffbc8c";
"use strict";
...
},{}],"9CsRS":[function(require,module,exports) {
const Web3 = require("4636b1f65f4a04d7");
// import configuration from '../build/contracts/MyNFT.json';
// const configuration = require('../build/contracts/MyNFT.json');
fetch("../build/contracts/MyNFT.json").then((response)=>response.json()).then((configuration1)=>console.log(configuration1));
const CONTRACT_ADDRESS = configuration.networks["5777"].address;
const CONTRACT_ABI = configuration.abi;
const web3 = new Web3(Web3.givenProvider || "http://127.0.0.1:7545");
const contract = new web3.eth.Contract(CONTRACT_ABI, CONTRACT_ADDRESS);
//Initializing Moralis
const Moralis = require("874b4ab3588a8521").default;
const fs = require("d8e96942629ad0d9");
let account;
...
async function createBat() {
    ...
    console.log(path);
    new_id = await contract.methods.mintNFT(path).send({
        from: account
    });
    console.log(new_id);
}
...
},{"4636b1f65f4a04d7":"caAX1","874b4ab3588a8521":"347Jf","d8e96942629ad0d9":"jhUEF"}]},["kYv7K","9CsRS"], "9CsRS", "parcelRequiree8ef")

//# sourceMappingURL=nftMinting.c4ffbc8c.js.map
